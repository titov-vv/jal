...
def test_ibkr_json_import(tmp_path, project_root, data_path, prepare_db_ibkr):
    ...
    test_assets = [
        ...
        {'id': 12, 'type_id': PredefinedAsset.Bond, 'full_name': 'X 6 1/4 03/15/26', 'country_id': 0,
         ...
         'data': {AssetData.ExpiryDate: '1773532800', AssetData.PrincipalValue: '1E+3'}},
    ...
    assert JalAccount(1).dump_transfers() == [
        [7, 4, 1580443370, 6, '890.47', 1580443370, 1, '1E+3', '2674343226', '', '', 'IDEALFX'],
        [8, 4, 1581322108, 2, '78986.6741', 1581322108, 1, '1234', '2645393202', '', '', 'IDEALFX'],
    ...
    # validate trades
    test_trades = [
        [17, 3, 1553545500, 1553545500, '', 1, 9, '-0.777', '168.37', ''],
        [18, 3, 1579094694, 1579219200, '2661774904', 1, 23, '4.5E+4', '0.0012', ''],
        [19, 3, 1580215513, 1580215513, '2674740000', 1, 4, '-1.24E+3', '54.84', ''],
        [20, 3, 1580215566, 1580342400, '2674741000', 1, 32, '-148', '316.68', ''],
        [21, 3, 1590595065, 1590710400, '2882737839', 1, 12, '2', '637.09', ''],
        [22, 3, 1592575273, 1592784000, '2931083780', 1, 33, '-1E+2', '4.54', ''],
        [23, 3, 1595607600, 1595808000, '2997636969', 1, 33, '1E+2', '0', 'Option assignment'],
        [24, 3, 1595607600, 1595607600, '2997636973', 1, 34, '1E+2', '64', 'Option assignment/exercise'],
        [25, 3, 1603882231, 1604016000, '3183801882', 1, 24, '5E+5', '0.0001', ''],
        [26, 3, 1640895900, 1640895900, '18952523919', 1, 31, '-3E+1', '0.1', 'BKSY WS(US09263B1162) MERGED(Liquidation) FOR USD 0.10 PER SHARE (BKSY WS, BKSY 30OCT24 11.5 C, US09263B1162)'],
        [27, 3, 1638822300, 1638822300, '18694975077', 1, 38, '-8', '1103.06815', '(US345370CV02) FULL CALL / EARLY REDEMPTION FOR USD 1.10306815 PER BOND (F 8 1/2 04/21/23, F 8 1/2 04/21/23, US345370CV02)'],
        [28, 3, 1640031900, 1640031900, '18882610202', 1, 44, '-99', '20.75', 'CORT.OD2(US218NSPODD6) MERGED(Voluntary Offer Allocation) FOR USD 20.75 PER SHARE (CORT.OD2, CORCEPT THERAPEUTICS INC - TENDER ODD LOT, US218NSPODD6)']
    ]
    ...
    # The fees of those trades and of the two transfers above, in the table they are stored in now
    assert {f[1]: f[5] for f in JalAccount(1).dump_fees()} == {
        7: '3', 8: '2', 18: '0.54', 19: '7.75519312', 20: '-5.007792848', 21: '2', 22: '1.1058334', 25: '0.7503675'}
...
def test_ukfu_json_import(tmp_path, project_root, data_path, prepare_db_moex):
    ...
    test_assets = [
        ...
        {'id': 10, 'type_id': PredefinedAsset.Bond, 'full_name': 'АО "Тинькофф Банк" БО-07', 'country_id': 0,
         ...
         'data': {AssetData.ExpiryDate: '1624492800', AssetData.PrincipalValue: '1E+3'}},
