...
def test_ibkr_json_import(tmp_path, project_root, data_path, prepare_db_ibkr):
    ...
    test_trades = [
        ...
        [18, 3, 1579094694, 1579219200, '2661774904', 1, 23, '4.5E+4', '0.0012', '0', ''],
        [19, 3, 1580215513, 1580215513, '2674740000', 1, 4, '-1.24E+3', '54.84', '0', ''],
        [20, 3, 1580215566, 1580342400, '2674741000', 1, 32, '-148', '316.68', '0', ''],
        [21, 3, 1590595065, 1590710400, '2882737839', 1, 12, '2', '637.09', '0', ''],
        [22, 3, 1592575273, 1592784000, '2931083780', 1, 33, '-1E+2', '4.54', '0', ''],
        ...
        [25, 3, 1603882231, 1604016000, '3183801882', 1, 24, '5E+5', '0.0001', '0', ''],
