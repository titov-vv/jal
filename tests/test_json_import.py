...
def test_ibkr_json_import(tmp_path, project_root, data_path, prepare_db_ibkr):
    ...
    test_assets = [
        ...
        {'id': 12, 'type_id': PredefinedAsset.Bond, 'full_name': 'X 6 1/4 03/15/26', 'isin': 'US912909AN84', 'country_id': 0, 'base_asset': '',
         ...
         'data': {AssetData.RegistrationCode: '912909AN8', AssetData.ExpiryDate: '1773532800'}},
        ...
        {'id': 28, 'type_id': PredefinedAsset.Bond, 'full_name': 'X 6 1/4 03/15/26 - PARTIAL CALL RED DATE 9/26', 'isin': 'US912CALAN84', 'country_id': 0, 'base_asset': '',
         ...
         'data': {AssetData.RegistrationCode: '912CALAN8', AssetData.ExpiryDate: '1773532800'}},
...
def test_ukfu_json_import(tmp_path, project_root, data_path, prepare_db_moex):
    ...
    test_assets = [
        ...
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'Аэрофлот-росс.авиалин(ПАО)ао', 'isin': 'RU0009062285', 'country_id': 0, 'base_asset': '',
        ...
        {'id': 11, 'type_id': PredefinedAsset.ETF, 'full_name': 'ЗПИФ Фонд ПНК-Рентал', 'isin': 'RU000A1013V9', 'country_id': 0, 'base_asset': '',
         'symbols': [{'symbol': 'ЗПИФ ПНК', 'description': 'MOEX', 'active': 1, 'currency_id': 1, 'quote_source': 1}],
         'data': {AssetData.RegistrationCode: '2770'}},
        ...
        {'id': 13, 'type_id': PredefinedAsset.Stock, 'full_name': 'Polymetal International plc', 'isin': 'JE00B6T5S470', 'country_id': 0, 'base_asset': '',
         'symbols': [{'symbol': 'POLY', 'description': 'MOEX', 'active': 1, 'currency_id': 1, 'quote_source': 1}]},
        {'id': 14, 'type_id': PredefinedAsset.Derivative, 'full_name': 'Фьючерсный контракт Si-12.21', 'isin': '', 'country_id': 0, 'base_asset': '',
         'symbols': [{'symbol': 'SiZ1', 'description': 'MOEX', 'active': 1, 'currency_id': 1, 'quote_source': 1}],
         'data': {AssetData.ExpiryDate: '1639612800'}},
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'ПАО Московская Биржа', 'isin': 'RU000A0JR4A1', 'country_id': 0, 'base_asset': '',
