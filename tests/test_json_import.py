...
def test_ibkr_json_import(tmp_path, project_root, data_path, prepare_db_ibkr):
    ...
    test_assets = [
        ...
        {'id': 4, 'type_id': PredefinedAsset.ETF, 'full_name': 'Growth ETF', 'country_id': 2,
         'symbols': [{'id': 4, 'symbol': 'VUG', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 5, 'type_id': PredefinedAsset.ETF, 'full_name': 'VANGUARD EXTENDED DUR TREAS', 'country_id': 2,
         'symbols': [{'id': 5, 'symbol': 'EDV', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {(5, SymbolId.CUSIP): '921910709'}},
        {'id': 6, 'type_id': PredefinedAsset.ETF, 'full_name': 'PIMCO 25+ YR ZERO CPN US TIF', 'country_id': 2,
         'symbols': [{'id': 6, 'symbol': 'ZROZ', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {(6, SymbolId.ISIN): 'US72201R8824', (6, SymbolId.CUSIP): '72201R882'}},
        {'id': 7, 'type_id': PredefinedAsset.Money, 'full_name': 'CAD', 'country_id': 0,
         'symbols': [{'id': 7, 'symbol': 'CAD', 'currency_id': 7, 'location_id': AssetLocation.BANK_ACCOUNT, 'active': 1}],
         'ID': {}},
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'AMAZON.COM INC', 'country_id': 0,
         'symbols': [{'id': 8, 'symbol': 'AMZN', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1}],
        ...
        {'id': 9, 'type_id': PredefinedAsset.Stock, 'full_name': 'ALIBABA GROUP HOLDING-SP ADR', 'country_id': 0,
         'symbols': [{'id': 9, 'symbol': 'BABA', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 10, 'type_id': PredefinedAsset.Stock, 'full_name': 'DOMINION ENERGY INC', 'country_id': 0,
         'symbols': [{'id': 10, 'symbol': 'D', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
         'ID': {(10, SymbolId.CUSIP): '25746U109'}},
        {'id': 11, 'type_id': PredefinedAsset.Stock, 'full_name': 'DOMINION ENERGY MIDSTREAM PA', 'country_id': 0,
         'symbols': [{'id': 11, 'symbol': 'DM', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
         'ID': {(11, SymbolId.CUSIP): '257454108'}},
        {'id': 12, 'type_id': PredefinedAsset.Bond, 'full_name': 'X 6 1/4 03/15/26', 'country_id': 0,
         'symbols': [{'id': 12, 'symbol': 'X 6 1/4 03/15/26', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 13, 'type_id': PredefinedAsset.Derivative, 'full_name': 'SPY 29MAY20 295.0 C', 'country_id': 0,
         'symbols': [{'id': 13, 'symbol': 'SPY   200529C00295000', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {},
         'data': {AssetData.ExpiryDate: '1590710400'}},
        {'id': 14, 'type_id': PredefinedAsset.Derivative, 'full_name': 'DSKEW 27FEB22 11.5 C', 'country_id': 0,
         'symbols': [{'id': 14, 'symbol': 'DSKEW', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1}],
        ...
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'MYLAN NV', 'country_id': 0,
         'symbols': [{'id': 15, 'symbol': 'MYL', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {(15, SymbolId.ISIN): 'NL0011031208'}},
        {'id': 16, 'type_id': PredefinedAsset.Stock, 'full_name': 'VIATRIS INC-W/I', 'country_id': 0,
         'symbols': [{'id': 16, 'symbol': 'VTRS', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1}],
        ...
        {'id': 17, 'type_id': PredefinedAsset.Stock, 'full_name': 'WABTEC CORP', 'country_id': 0,
         'symbols': [{'id': 17, 'symbol': 'WAB', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1},
                     {'id': 18, 'symbol': 'WBB', 'currency_id': 7, 'location_id': AssetLocation.TMX_EXCHANGE, 'active': 1}],
        ...
        {'id': 18, 'type_id': PredefinedAsset.Stock, 'full_name': 'TELEFONICA SA-SPON ADR', 'country_id': 0,
         'symbols': [{'id': 19, 'symbol': 'TEF', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 19, 'type_id': PredefinedAsset.Stock, 'full_name': 'EQM MIDSTREAM PARTNERS LP', 'country_id': 0,
         'symbols': [{'id': 20, 'symbol': 'EQM', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 20, 'type_id': PredefinedAsset.Stock, 'full_name': 'EQUITRANS MIDSTREAM CORP', 'country_id': 0,
         'symbols': [{'id': 21, 'symbol': 'ETRN', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 21, 'type_id': PredefinedAsset.Stock, 'full_name': 'GENERAL ELECTRIC CO', 'country_id': 0,
         'symbols': [{'id': 22, 'symbol': 'GE', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 22, 'type_id': PredefinedAsset.Stock, 'full_name': 'EWELLNESS HEALTHCARE CORP', 'country_id': 0,
         'symbols': [{'id': 23, 'symbol': 'EWLL', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 23, 'type_id': PredefinedAsset.Stock, 'full_name': 'EWELLNESS HEALTHCARE CORP', 'country_id': 0,
         'symbols': [{'id': 24, 'symbol': 'EWLL', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 0},
                     {'id': 36, 'symbol': 'EWLLD', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 24, 'type_id': PredefinedAsset.Stock, 'full_name': 'LIVONGO HEALTH INC', 'country_id': 0,
         'symbols': [{'id': 25, 'symbol': 'LVGO', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 25, 'type_id': PredefinedAsset.Stock, 'full_name': 'TELADOC HEALTH INC', 'country_id': 0,
         'symbols': [{'id': 26, 'symbol': 'TDOC', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 26, 'type_id': PredefinedAsset.Stock, 'full_name': 'LUMEN TECHNOLOGIES INC', 'country_id': 0,
         'symbols': [{'id': 27, 'symbol': 'LUMN', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 27, 'type_id': PredefinedAsset.Stock, 'full_name': 'CENTURYLINK INC', 'country_id': 0,
         'symbols': [{'id': 28, 'symbol': 'LUMN', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 28, 'type_id': PredefinedAsset.Bond, 'full_name': 'X 6 1/4 03/15/26 - PARTIAL CALL RED DATE 9/26', 'country_id': 0,
         'symbols': [{'id': 29, 'symbol': 'X 6 1/4 03/15/26 - PARTIAL CALL RED DATE 9/26', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 29, 'type_id': PredefinedAsset.Derivative, 'full_name': 'BKSY 30DEC24 11.5 C', 'country_id': 0,
         'symbols': [{'id': 30, 'symbol': 'SFTW WS', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
        ...
        {'id': 30, 'type_id': PredefinedAsset.Derivative, 'full_name': 'BKSY 30DEC24 11.5 C', 'country_id': 0,
         'symbols': [{'id': 31, 'symbol': 'BKSY WS', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1}],
         'ID': {(31, SymbolId.ISIN): 'US09263B1162'},
         'data': {AssetData.ExpiryDate: '1735516800'}},
        {'id': 31, 'type_id': PredefinedAsset.Stock, 'full_name': 'APPLE INC', 'country_id': 0,
         'symbols': [{'id': 32, 'symbol': 'AAPL', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1}],
    ...
    assert JalAccount(1).dump_transfers() == [
        ...
        [5, 4, 1605744000, 1, '1234.0', 1605744000, '', '1234.0', '', '', '14333901913', '', '', '', 'DISBURSEMENT INITIATED BY John Doe'],
        [6, 4, 1663372800, '', '100.0', 1663372800, 1, '100.0', '', '', '1234567890', '', '', '', 'CASH RECEIPTS / ELECTRONIC FUND TRANSFERS'],
        [7, 4, 1663372800, '', '100.0', 1663372800, 1, '100.0', '', '', '1234567891', '', '', '', 'CASH RECEIPTS / ELECTRONIC FUND TRANSFERS'],
    ...
    test_asset_actions = [
        [1, 5, 1618345500, 0, '16074977038', 1, 4, 8, '217.0', 'AMZN(US0231351067) SPLIT 5 FOR 4 (AMZN, AMAZON.COM INC, US0231351067)', [1, 1, 8, '271.25', '1.0']],
        [2, 5, 1605731100, 0, '10162291403', 1, 1, 11, '70.0', 'DM(US2574541080) MERGED(Acquisition) WITH US25746U1097 2492 FOR 10000 (D, DOMINION ENERGY INC, 25746U109)', [2, 2, 10, '17.444', '0.0']],
        [3, 5, 1605558300, 0, '14302257657', 1, 3, 15, '5.0', 'MYL(NL0011031208) CUSIP/ISIN CHANGE TO (US92556V1061) (VTRS, VIATRIS INC-W/I, US92556V1061)', [3, 3, 16, '5.0', '1.0']],
        [4, 5, 1605817500, 0, '10302900848', 1, 2, 22, '100', 'GE(US3696041033) SPINOFF  5371 FOR 1000000 (WAB, WABTEC CORP, 929740108)', [4, 4, 22, '100', '0.0'], [5, 4, 17, '0.5371', '0.0']],
        [5, 5, 1592339100, 0, '13006963996', 1, 1, 20, '70.0', 'EQM(US26885B1008) MERGED(Voluntary Offer Allocation) WITH US2946001011 244 FOR 100 (ETRN, EQUITRANS MIDSTREAM CORP, US2946001011)', [6, 5, 21, '170.8', '0.0']],
        [6, 5, 1604089500, 0, '14147163475', 1, 1, 25, '10.0', 'LVGO(US5391831030) CASH and STOCK MERGER (Acquisition) US87918A1051 592 FOR 1000 AND EUR 4.24 (TDOC, TELADOC HEALTH INC, US87918A1051)', [7, 6, 3, '42.4', '0.0'], [8, 6, 26, '5.92', '0.0']],
        [7, 5, 1611260700, 0, '15015004953', 1, 1, 28, '200.0', 'LUMN.OLD(US1567001060) MERGED(Acquisition) WITH US5502411037 1 FOR 1 (LUMN, LUMEN TECHNOLOGIES INC, US5502411037)', [9, 7, 27, '200.0', '0.0']],
        [8, 5, 1630007100, 0, '17569476329', 1, 1, 12, '2.0', 'X 6 1/4 03/15/26(US912909AN84) TENDERED TO US912CALAN84 1 FOR 1 (X 6 1/4 03/15/26 - PARTIAL CALL RED DATE 9/26, X 6 1/4 03/15/26 - PARTIAL CALL RED DATE 9/26, US912CALAN84)', [10, 8, 29, '2.0', '0.0']],
        [9, 5, 1631219100, 0, '17667047189', 1, 3, 30, '20.0', 'SFTW WS(US68839R1207) CUSIP/ISIN CHANGE TO (US09263B1162) (BKSY WS, BKSY 30OCT24 11.5 C, US09263B1162)', [11, 9, 31, '20.0', '1.0']],
        [10, 5, 1581452700, 0, '12029570527', 1, 4, 23, '45000.0', 'EWLL(US30051D1063) SPLIT 1 FOR 50 (EWLLD, EWELLNESS HEALTHCARE CORP, US30051D2053)', [12, 10, 36, '900.0', '1.0']],
        [11, 5, 1627676700, 0, '17240033443', 1, 4, 22, '104.0', 'GE(US3696041033) SPLIT 1 FOR 8 (GE, GENERAL ELECTRIC CO, US3696043013)', [13, 11, 37, '13.0', '1.0']],
        [12, 5, 1627331100, 0, '17200082800', 1, 1, 41, '610.0', 'BPYU(US11282X1037) CASH and STOCK MERGER (Acquisition) BAM 9133631 FOR 100000000, G1624R107 6572057 FOR 100000000 AND USD 12.38424741 (BAM, BROOKFIELD ASSET MANAGE-CL A, CA1125851040)', [14, 12, 2, '7554.3909201', '0.0'], [15, 12, 39, '55.7151', '0.0'], [16, 12, 40, '40.0895', '0.0']],
        [13, 5, 1633033500, 0, '17897699521', 1, 2, 22, '320', 'GE(US3696041033) SPINOFF  1 FOR 11 (SLVM, SYLVAMO CORP, US8713321029)', [17, 13, 22, '320', '0.0'], [18, 13, 42, '29.0909', '0.0']],
        [14, 5, 1639597500, 0, '18787960371', 1, 1, 43, '99.0', 'CORT(US2183521028) TENDERED TO US218NSPODD6 1 FOR 1 (CORT.OD2, CORCEPT THERAPEUTICS INC - TENDER ODD LOT, US218NSPODD6)', [19, 14, 44, '99.0', '0.0']],
        [15, 5, 1612470300, 0, '15238437826', 1, 5, 45, '20000.0', '(CA6295231014) DELISTED (NABIF, NABIS HOLDINGS INC, CA6295231014)']
    ]
...
def test_ukfu_json_import(tmp_path, project_root, data_path, prepare_db_moex):
    ...
    test_assets = [
        ...
        {'id': 4, 'type_id': PredefinedAsset.Stock, 'full_name': '', 'country_id': 0,
         'symbols': [{'id': 4, 'symbol': 'SBER', 'currency_id': 1, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 5, 'type_id': PredefinedAsset.Derivative, 'full_name': 'Si-12.11 Контракт на курс доллар-рубль', 'country_id': 0,
         'symbols': [{'id': 5, 'symbol': 'SiZ1', 'currency_id': 1, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {}},
        {'id': 6, 'type_id': PredefinedAsset.Bond, 'full_name': '', 'country_id': 0,
         'symbols': [{'id': 6, 'symbol': 'SU26238RMFS4', 'currency_id': 1, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {(6, SymbolId.ISIN): 'RU000A1038V6'}},
        {'id': 7, 'type_id': PredefinedAsset.Bond, 'full_name': '', 'country_id': 0,
         'symbols': [{'id': 7, 'symbol': 'МКБ 1P2', 'currency_id': 1, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
         'ID': {(7, SymbolId.ISIN): 'RU000A1014H6'}},
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'АО Аэрофлот', 'country_id': 0,
         'symbols': [{'id': 8, 'symbol': 'AFLT', 'currency_id': 1, 'location_id': AssetLocation.UNDEFINED, 'active': 1}],
        ...
        {'id': 9, 'type_id': PredefinedAsset.ETF, 'full_name': 'FinEx Gold ETF USD', 'country_id': 0,
         'symbols': [{'id': 9, 'symbol': 'FXGD', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
         'ID': {(9, SymbolId.ISIN): 'IE00B8XB7377'}},
        {'id': 10, 'type_id': PredefinedAsset.Bond, 'full_name': 'АО "Тинькофф Банк" БО-07', 'country_id': 0,
         'symbols': [{'id': 10, 'symbol': 'ТинькоффБ7', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
        ...
        {'id': 11, 'type_id': PredefinedAsset.Stock, 'full_name': 'ао ПАО Банк ВТБ', 'country_id': 0,
         'symbols': [{'id': 11, 'symbol': 'VTBR', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
        ...
        {'id': 12, 'type_id': PredefinedAsset.Derivative, 'full_name': 'Фьючерсный контракт Si-12.21', 'country_id': 0,
         'symbols': [{'id': 12, 'symbol': 'SiZ1', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
         'ID': {},
         'data': {AssetData.ExpiryDate: '1639612800'}},
        {'id': 13, 'type_id': PredefinedAsset.Stock, 'full_name': 'ПАО Московская Биржа', 'country_id': 0,
         'symbols': [{'id': 13, 'symbol': 'MOEX', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
        ...
        {'id': 14, 'type_id': PredefinedAsset.Stock, 'full_name': 'Polymetal International plc', 'country_id': 0,
         'symbols': [{'id': 14, 'symbol': 'POLY', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
         'ID': {(14, SymbolId.ISIN): 'JE00B6T5S470'}},
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'Северсталь (ПАО)ао', 'country_id': 0,
         'symbols': [{'id': 15, 'symbol': 'CHMF', 'currency_id': 1, 'location_id': AssetLocation.MOEX_EXCHANGE, 'active': 1}],
