...
def test_ibkr_json_import(tmp_path, project_root, data_path, prepare_db_ibkr):
    ...
    test_assets = [
        ...
        {'id': 13, 'type_id': PredefinedAsset.Derivative, 'full_name': 'SPY 29MAY20 295.0 C', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'SPY   200529C00295000', 'description': '', 'active': 1, 'currency_id': 2, 'quote_source': -1}],
         'data': {AssetData.ExpiryDate: '1590710400'}},
        {'id': 14, 'type_id': PredefinedAsset.Derivative, 'full_name': 'DSKEW 27FEB22 11.5 C', 'isin': 'US23753F1158', 'country_id': 0,
        ...
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'MYLAN NV', 'isin': 'NL0011031208', 'country_id': 0,
         'symbols': [{'symbol': 'MYL', 'description': '', 'active': 1, 'currency_id': 2, 'quote_source': -1}]},
        {'id': 16, 'type_id': PredefinedAsset.Stock, 'full_name': 'VIATRIS INC-W/I', 'isin': 'US92556V1061', 'country_id': 0,
         'symbols': [{'symbol': 'VTRS', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '92556V106'}},
        {'id': 17, 'type_id': PredefinedAsset.Stock, 'full_name': 'WABTEC CORP', 'isin': '', 'country_id': 0,
        ...
        {'id': 18, 'type_id': PredefinedAsset.Stock, 'full_name': 'TELEFONICA SA-SPON ADR', 'isin': 'US8793822086', 'country_id': 0,
         'symbols': [{'symbol': 'TEF', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '879382208'}},
        {'id': 19, 'type_id': PredefinedAsset.Stock, 'full_name': 'EQM MIDSTREAM PARTNERS LP', 'isin': 'US26885B1008','country_id': 0,
         'symbols': [{'symbol': 'EQM', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '26885B100'}},
        {'id': 20, 'type_id': PredefinedAsset.Stock, 'full_name': 'EQUITRANS MIDSTREAM CORP', 'isin': 'US2946001011', 'country_id': 0,
         'symbols': [{'symbol': 'ETRN', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '294600101'}},
        {'id': 21, 'type_id': PredefinedAsset.Stock, 'full_name': 'GENERAL ELECTRIC CO', 'isin': 'US3696041033', 'country_id': 0,
         'symbols': [{'symbol': 'GE', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '369604103'}},
        {'id': 22, 'type_id': PredefinedAsset.Stock, 'full_name': 'EWELLNESS HEALTHCARE CORP', 'isin': 'US30051D1063', 'country_id': 0,
         'symbols': [{'symbol': 'EWLL', 'description': 'PINK', 'active': 1, 'currency_id': 2, 'quote_source': -1}],
         'data': {AssetData.RegistrationCode: '30051D106'}},
        {'id': 23, 'type_id': PredefinedAsset.Stock, 'full_name': 'EWELLNESS HEALTHCARE CORP', 'isin': 'US30051D2053', 'country_id': 0,
        ...
        {'id': 24, 'type_id': PredefinedAsset.Stock, 'full_name': 'LIVONGO HEALTH INC', 'isin': 'US5391831030', 'country_id': 0,
         'symbols': [{'symbol': 'LVGO', 'description': '', 'active': 1, 'currency_id': 2, 'quote_source': -1}],
         'data': {AssetData.RegistrationCode: '539183103'}},
        {'id': 25, 'type_id': PredefinedAsset.Stock, 'full_name': 'TELADOC HEALTH INC', 'isin': 'US87918A1051', 'country_id': 0,
         'symbols': [{'symbol': 'TDOC', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '87918A105'}},
        {'id': 26, 'type_id': PredefinedAsset.Stock, 'full_name': 'LUMEN TECHNOLOGIES INC', 'isin': 'US5502411037', 'country_id': 0,
         'symbols': [{'symbol': 'LUMN', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '550241103'}},
        {'id': 27, 'type_id': PredefinedAsset.Stock, 'full_name': 'CENTURYLINK INC', 'isin': 'US1567001060', 'country_id': 0,
         'symbols': [{'symbol': 'LUMN', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '156700106'}},
        {'id': 28, 'type_id': PredefinedAsset.Bond, 'full_name': 'X 6 1/4 03/15/26 - PARTIAL CALL RED DATE 9/26', 'isin': 'US912CALAN84', 'country_id': 0,
        ...
        {'id': 29, 'type_id': PredefinedAsset.Derivative, 'full_name': 'BKSY 30DEC24 11.5 C', 'isin': 'US68839R1207', 'country_id': 0,
        ...
        {'id': 30, 'type_id': PredefinedAsset.Derivative, 'full_name': 'BKSY 30DEC24 11.5 C', 'isin': 'US09263B1162', 'country_id': 0,
         'symbols': [{'symbol': 'BKSY WS', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.ExpiryDate: '1735516800'}},
        {'id': 31, 'type_id': PredefinedAsset.Stock, 'full_name': 'APPLE INC', 'isin': 'US0378331005', 'country_id': 0,
         'symbols': [{'symbol': 'AAPL', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '037833100'}},
        {'id': 32, 'type_id': PredefinedAsset.Derivative, 'full_name': 'VLO 24JUL20 64.0 P', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'VLO   200724P00064000', 'description': 'CBOE', 'active': 1, 'currency_id': 2, 'quote_source': -1}]},
        {'id': 33, 'type_id': PredefinedAsset.Stock, 'full_name': 'VALERO ENERGY CORP', 'isin': 'US91913Y1001', 'country_id': 0,
         'symbols': [{'symbol': 'VLO', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '91913Y100'}},
        {'id': 34, 'type_id': PredefinedAsset.Stock, 'full_name': '', 'isin': 'US5543821012', 'country_id': 0,
         'symbols': [{'symbol': 'MAC', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '554382101'}},
        {'id': 35, 'type_id': PredefinedAsset.Stock, 'full_name': '', 'isin': 'US3696043013', 'country_id': 0,
         'symbols': [{'symbol': 'GE', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '369604301'}},
        {'id': 36, 'type_id': PredefinedAsset.Bond, 'full_name': '', 'isin': 'US345370CV02', 'country_id': 0,
        ...
        {'id': 42, 'type_id': PredefinedAsset.Stock, 'full_name': '', 'isin': 'US218NSPODD6', 'country_id': 0,
         ...
         {'id': 43, 'type_id': PredefinedAsset.Stock, 'full_name': '', 'isin': 'CA6295231014', 'country_id': 0,
...
def test_ukfu_json_import(tmp_path, project_root, data_path, prepare_db_moex):
    ...
    test_assets = [
        ...
        {'id': 3, 'type_id': PredefinedAsset.Money, 'full_name': 'Евро', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'EUR', 'description': 'Евро', 'active': 1, 'currency_id': '', 'quote_source': 0}]},
        {'id': 4, 'type_id': PredefinedAsset.Stock, 'full_name': '', 'isin': 'RU0009029540', 'country_id': 0,
         'symbols': [{'symbol': 'SBER',  'description': '', 'active': 1,'currency_id': 1, 'quote_source': -1}]},
        {'id': 5, 'type_id': PredefinedAsset.Derivative, 'full_name': 'Si-12.11 Контракт на курс доллар-рубль', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'SiZ1', 'description': '', 'active': 1, 'currency_id': 1, 'quote_source': -1}]},
        {'id': 6, 'type_id': PredefinedAsset.Bond, 'full_name': '', 'isin': 'RU000A1038V6', 'country_id': 0,
         'symbols': [{'symbol': 'SU26238RMFS4', 'description': '', 'active': 1, 'currency_id': 1, 'quote_source': -1}]},
        {'id': 7, 'type_id': PredefinedAsset.Bond, 'full_name': '', 'isin': 'RU000A1014H6', 'country_id': 0,
         'symbols': [{'symbol': 'МКБ 1P2', 'description': '', 'active': 1, 'currency_id': 1, 'quote_source': -1}]},
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'АО Аэрофлот', 'isin': 'RU0009062285', 'country_id': 0,
         'symbols': [{'symbol': 'AFLT', 'description': '', 'active': 1, 'currency_id': 1, 'quote_source': -1}],
         'data': {AssetData.RegistrationCode: '1-01-00010-A'}},
        {'id': 9, 'type_id': PredefinedAsset.ETF, 'full_name': 'FinEx Gold ETF USD', 'isin': 'IE00B8XB7377', 'country_id': 0,
         'symbols': [{'symbol': 'FXGD', 'description': 'MOEX', 'active': 1, 'currency_id': 1, 'quote_source': 1}]},
        {'id': 10, 'type_id': PredefinedAsset.Bond, 'full_name': 'АО "Тинькофф Банк" БО-07', 'isin': 'RU000A0JWM31', 'country_id': 0,
        ...
        {'id': 11, 'type_id': PredefinedAsset.Stock, 'full_name': 'ао ПАО Банк ВТБ', 'isin': 'RU000A0JP5V6', 'country_id': 0,
         'symbols': [{'symbol': 'VTBR', 'description': 'MOEX', 'active': 1, 'currency_id': 1, 'quote_source': 1}],
         'data': {AssetData.RegistrationCode: '10401000B'}},
        {'id': 12, 'type_id': PredefinedAsset.Derivative, 'full_name': 'Фьючерсный контракт Si-12.21', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'SiZ1', 'description': 'MOEX', 'active': 1, 'currency_id': 1, 'quote_source': 1}],
         'data': {AssetData.ExpiryDate: '1639612800'}},
        {'id': 13, 'type_id': PredefinedAsset.Stock, 'full_name': 'ПАО Московская Биржа', 'isin': 'RU000A0JR4A1', 'country_id': 0,
        ...
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'Северсталь (ПАО)ао', 'isin': 'RU0009046510', 'country_id': 0,
