...
def test_ibkr_json_import(tmp_path, project_root, data_path, prepare_db_ibkr):
    ...
    test_asset_actions = [
        ...
        [4, 5, 1605817500, '10302900848', 1, 2, 21, 100.0, 'GE(US3696041033) SPINOFF  5371 FOR 1000000 (WAB, WABTEC CORP, 929740108)'],
        ...
        [13, 5, 1633033500, '17897699521', 1, 2, 21, 320.0, 'GE(US3696041033) SPINOFF  1 FOR 11 (SLVM, SYLVAMO CORP, US8713321029)'],
    ...
    test_action_results = [
        ...
        [2, 2, 10, 17.444, 1.0],
        [3, 3, 16, 5.0, 1.0],
        [4, 4, 21, 100.0, 1.0], [5, 4, 17, 0.5371, 0.0],
        [6, 5, 20, 170.8, 1.0],
        [7, 6, 23, 900.0, 1.0],
        [8, 7, 3, 42.4, 0.0], [9, 7, 25, 5.92, 1.0],
        [10, 8, 26, 200.0, 1.0],
        [11, 9, 28, 2.0, 1.0],
        [12, 10, 30, 20.0, 1.0],
        [13, 11, 35, 13.0, 1.0],
        [14, 12, 2, 7554.3909201, 0.0], [15, 12, 37, 55.7151, 1.0], [16, 12, 38, 40.0895, 0.0],
        [17, 13, 21, 320.0, 1.0], [18, 13, 40, 29.0909, 0.0],
        [19, 14, 42, 99.0, 1.0]
    ]
