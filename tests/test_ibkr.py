...
def test_statement_ibkr(tmp_path, project_root, data_path, prepare_db_taxes):
    ...
    test_assets = [
        ...
        {'id': 4, 'type_id': PredefinedAsset.Stock, 'full_name': 'PACIFIC ETHANOL INC', 'country_id': 0,
         'symbols': [{'id': 4, 'symbol': 'PEIX', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(4, SymbolId.ISIN): 'US69423U3059', (4, SymbolId.REG_CODE): '69423U305'}},
        {'id': 5, 'type_id': PredefinedAsset.Derivative, 'full_name': 'FANG 21JAN22 40.0 C', 'country_id': 0,
         'symbols': [{'id': 5, 'symbol': 'FANG  220121C00040000', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1, 'icon': ''}],
         'ID': {},
         'data': {AssetData.ExpiryDate: '1642723200'}},
        {'id': 6, 'type_id': PredefinedAsset.Stock, 'full_name': 'EXXON MOBIL CORP', 'country_id': 2,
         'symbols': [{'id': 6, 'symbol': 'XOM', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(6, SymbolId.ISIN): 'US30231G1022', (6, SymbolId.REG_CODE): '30231G102'}},
        {'id': 7, 'type_id': PredefinedAsset.Derivative, 'full_name': 'XOM 21JAN22 42.5 C', 'country_id': 0,
         'symbols': [{'id': 7, 'symbol': 'XOM   220121C00042500', 'currency_id': 2, 'location_id': AssetLocation.UNDEFINED, 'active': 1, 'icon': ''}],
         'ID': {},
         'data': {AssetData.ExpiryDate: '1642723200'}},
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'AURORA CANNABIS INC', 'country_id': 0,
         'symbols': [{'id': 8, 'symbol': 'ACB', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(8, SymbolId.REG_CODE): '05156X108'}},
        {'id': 9, 'type_id': PredefinedAsset.Stock, 'full_name': 'TWO HARBORS INVESTMENT CORP', 'country_id': 2,
         'symbols': [{'id': 9, 'symbol': 'TWO', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(9, SymbolId.ISIN): 'US90187B4086', (9, SymbolId.REG_CODE): '90187B408'}},
        {'id': 10, 'type_id': PredefinedAsset.Stock, 'full_name': 'NEW RESIDENTIAL INVESTMENT', 'country_id': 2,
         'symbols': [{'id': 10, 'symbol': 'NRZ', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(10, SymbolId.ISIN): 'US64828T2015', (10, SymbolId.REG_CODE): '64828T201'}},
        {'id': 11, 'type_id': PredefinedAsset.Stock, 'full_name': 'INTERACTIVE BROKERS GRO-CL A', 'country_id': 0,
         'symbols': [{'id': 11, 'symbol': 'IBKR', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(11, SymbolId.ISIN): 'US45841N1072', (11, SymbolId.REG_CODE): '45841N107'}},
        {'id': 12, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'country_id': 0,
         'symbols': [{'id': 12, 'symbol': 'VERB', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(12, SymbolId.ISIN): 'US92337U1043', (12, SymbolId.REG_CODE): '92337U104'}}
    ]
    ...
    test_assets = [
        ...
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'AURORA CANNABIS INC', 'country_id': 0,
         'symbols': [{'id': 8, 'symbol': 'ACB', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(8, SymbolId.ISIN): 'CA05156X1087', (8, SymbolId.REG_CODE): '05156X108'}},
        {'id': 9, 'type_id': PredefinedAsset.Stock, 'full_name': 'TWO HARBORS INVESTMENT CORP', 'country_id': 2,
         'symbols': [{'id': 9, 'symbol': 'TWO', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(9, SymbolId.ISIN): 'US90187B4086', (9, SymbolId.REG_CODE): '90187B408'}},
        {'id': 10, 'type_id': PredefinedAsset.Stock, 'full_name': 'NEW RESIDENTIAL INVESTMENT', 'country_id': 2,
         'symbols': [{'id': 10, 'symbol': 'NRZ', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 0, 'icon': ''},
                     {'id': 15, 'symbol': 'RITM', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(10, SymbolId.ISIN): 'US64828T2015', (10, SymbolId.REG_CODE): '64828T201', (15, SymbolId.ISIN): 'US64828T2015', (15, SymbolId.REG_CODE): '64828T201'}},
        {'id': 11, 'type_id': PredefinedAsset.Stock, 'full_name': 'INTERACTIVE BROKERS GRO-CL A', 'country_id': 0,
         'symbols': [{'id': 11, 'symbol': 'IBKR', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(11, SymbolId.ISIN): 'US45841N1072', (11, SymbolId.REG_CODE): '45841N107'}},
        {'id': 12, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'country_id': 0,
        ...
        {'id': 13, 'type_id': PredefinedAsset.Stock, 'full_name': 'ALTO INGREDIENTS INC', 'country_id': 0,
         'symbols': [{'id': 13, 'symbol': 'ALTO', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 0, 'icon': ''},
                     {'id': 21, 'symbol': 'PEIX', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(13, SymbolId.ISIN): 'US0215131063', (13, SymbolId.REG_CODE): '021513106', (21, SymbolId.ISIN): 'US0215131063', (21, SymbolId.REG_CODE): '021513106'}},
        {'id': 14, 'type_id': PredefinedAsset.Stock, 'full_name': 'AURORA CANNABIS INC', 'country_id': 0,
         'symbols': [{'id': 14, 'symbol': 'ACB', 'currency_id': 2, 'location_id': AssetLocation.NYSE_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(14, SymbolId.ISIN): 'CA05156X8843', (14, SymbolId.REG_CODE): '05156X884'}},
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'country_id': 0,
         'symbols': [{'id': 16, 'symbol': 'VERB', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(16, SymbolId.ISIN): 'US92337U2033', (16, SymbolId.REG_CODE): '92337U203'}},
        {'id': 16, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'country_id': 0,
         'symbols': [{'id': 17, 'symbol': 'VERB', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(17, SymbolId.ISIN): 'US92337U3023', (17, SymbolId.REG_CODE): '92337U302'}},
        {'id': 17, 'type_id': PredefinedAsset.Stock, 'full_name': 'VOLCON INC', 'country_id': 0,
         'symbols': [{'id': 18, 'symbol': 'VLCN', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(18, SymbolId.ISIN): 'US92864V4005', (18, SymbolId.REG_CODE): '92864V400'}},
        {'id': 18, 'type_id': PredefinedAsset.Stock, 'full_name': 'VOLCON INC', 'country_id': 0,
         'symbols': [{'id': 19, 'symbol': 'VLCN', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(19, SymbolId.ISIN): 'US92864V2025', (19, SymbolId.REG_CODE): '92864V202'}},
        {'id': 19, 'type_id': PredefinedAsset.Stock, 'full_name': 'VOLCON INC', 'country_id': 0,
         'symbols': [{'id': 20, 'symbol': 'VLCN', 'currency_id': 2, 'location_id': AssetLocation.NASDAQ_EXCHANGE, 'active': 1, 'icon': ''}],
         'ID': {(20, SymbolId.ISIN): 'US92864V3015', (20, SymbolId.REG_CODE): '92864V301'}}
    ]
    assets = JalAsset.get_assets()
    assert len(assets) == len(test_assets)
    assert [x.dump() for x in assets] == test_assets
    ...
    test_trades = [
        ...
        [4, 3, 1606821387, 1606953600, '3264444280', 1, 4, '70.0', '6.08', '0.32925725', ''],
        [5, 3, 1607095765, 1607299200, '3276656996', 1, 7, '-100.0', '5.2', '0.667292', ''],
        [6, 3, 1610625615, 1611014400, '3381623127', 1, 21, '-70.0', '7.42', '0.23706599', ''],
