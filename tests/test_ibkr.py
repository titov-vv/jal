...
def test_statement_ibkr(tmp_path, project_root, data_path, prepare_db_taxes):
    ...
    test_assets = [
        ...
        {'id': 3, 'type_id': PredefinedAsset.Money, 'full_name': 'Евро', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'EUR', 'description': 'Евро', 'active': 1, 'currency_id': '', 'quote_source': 0}]},
        {'id': 4, 'type_id': PredefinedAsset.Stock, 'full_name': 'PACIFIC ETHANOL INC', 'isin': 'US69423U3059', 'country_id': 0,
         'symbols': [{'symbol': 'PEIX', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '69423U305'}},
        {'id': 5, 'type_id': PredefinedAsset.Derivative, 'full_name': 'FANG 21JAN22 40.0 C', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'FANG  220121C00040000', 'description': 'CBOE', 'active': 1, 'currency_id': 2, 'quote_source': -1}],
         'data': {AssetData.ExpiryDate: str(d2t(220121))}},
        {'id': 6, 'type_id': PredefinedAsset.Stock, 'full_name': 'EXXON MOBIL CORP', 'isin': 'US30231G1022', 'country_id': 2,
         'symbols': [{'symbol': 'XOM', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '30231G102'}},
        {'id': 7, 'type_id': PredefinedAsset.Derivative, 'full_name': 'XOM 21JAN22 42.5 C', 'isin': '', 'country_id': 0,
         'symbols': [{'symbol': 'XOM   220121C00042500', 'description': 'CBOE', 'active': 1, 'currency_id': 2, 'quote_source': -1}],
         'data': {AssetData.ExpiryDate: str(d2t(220121))}},
        {'id': 8, 'type_id': PredefinedAsset.Stock, 'full_name': 'AURORA CANNABIS INC', 'isin': 'CA05156X1087', 'country_id': 0,
         'symbols': [{'symbol': 'ACB', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {AssetData.RegistrationCode: '05156X108'}},
        {'id': 9, 'type_id': PredefinedAsset.Stock, 'full_name': 'TWO HARBORS INVESTMENT CORP', 'isin': 'US90187B4086', 'country_id': 2,
         'symbols': [{'symbol': 'TWO', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '90187B408'}},
        {'id': 10, 'type_id': PredefinedAsset.Stock, 'full_name': 'NEW RESIDENTIAL INVESTMENT', 'isin': 'US64828T2015', 'country_id': 2,
         ...
         'data': {1: '64828T201'}},
        {'id': 11, 'type_id': PredefinedAsset.Stock, 'full_name': 'INTERACTIVE BROKERS GRO-CL A', 'isin': 'US45841N1072', 'country_id': 0,
         'symbols': [{'symbol': 'IBKR', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '45841N107'}},
        {'id': 12, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'isin': 'US92337U1043', 'country_id': 0,
            'symbols': [{'symbol': 'VERB', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
            'data': {1: '92337U104'}},
        {'id': 13, 'type_id': PredefinedAsset.Stock, 'full_name': 'ALTO INGREDIENTS INC', 'isin': 'US0215131063', 'country_id': 0,
        ...
        {'id': 14, 'type_id': PredefinedAsset.Stock, 'full_name': 'AURORA CANNABIS INC', 'isin': 'CA05156X8843', 'country_id': 0,
         'symbols': [{'symbol': 'ACB', 'description': 'NYSE', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '05156X884'}},
        {'id': 15, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'isin': 'US92337U2033', 'country_id': 0,
         'symbols': [{'symbol': 'VERB', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '92337U203'}},
        {'id': 16, 'type_id': PredefinedAsset.Stock, 'full_name': 'VERB TECHNOLOGY CO INC', 'isin': 'US92337U3023', 'country_id': 0,
         'symbols': [{'symbol': 'VERB', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '92337U302'}},
        {'id': 17,  'type_id': PredefinedAsset.Stock, 'full_name': 'VOLCON INC', 'isin': 'US92864V4005', 'country_id': 0,
         'symbols': [{'symbol': 'VLCN', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '92864V400'}},
        {'id': 18, 'type_id': PredefinedAsset.Stock, 'full_name': 'VOLCON INC', 'isin': 'US92864V2025', 'country_id': 0,
         'symbols': [{'symbol': 'VLCN', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '92864V202'}},
        {'id': 19, 'type_id': PredefinedAsset.Stock, 'full_name': 'VOLCON INC', 'isin': 'US92864V3015', 'country_id': 0,
         'symbols': [{'symbol': 'VLCN', 'description': 'NASDAQ', 'active': 1, 'currency_id': 2, 'quote_source': 2}],
         'data': {1: '92864V301'}}
    ]
    assets = JalAsset.get_assets()
