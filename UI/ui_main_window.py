...
class Ui_LedgerMainWindow(object):
    def setupUi(self, LedgerMainWindow):
        ...
        self.MakeIncomeSpendingReport = QAction(LedgerMainWindow)
        self.MakeIncomeSpendingReport.setObjectName(u"MakeIncomeSpendingReport")
        ...
        self.menu_Reports.addAction(self.MakeIncomeSpendingReport)
    ...
    def retranslateUi(self, LedgerMainWindow):
        ...
        self.action_Import.setText(QCoreApplication.translate("LedgerMainWindow", u"&Import old...", None))
        ...
        self.MakeIncomeSpendingReport.setText(QCoreApplication.translate("LedgerMainWindow", u"&Income/Spending report", None))
