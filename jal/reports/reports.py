...
class Reports(QObject):
    ...
    def loadReportsList(self):
        reports_folder = JalSettings.path(JalSettings.PATH_APP) + Setup.REPORT_PATH
    ...
    def show(self, action):
        ...
        self._mdi.addWindow(report)

    def show_report(self, window_class, settings, floating=True):
        ...
        self._mdi.addWindow(report, floating=floating)
