...
class TaxesRus:
    ...
    def prepare_exchange_rate_dates(self):
        ...
        _ = executeSQL("INSERT INTO t_last_dates(ref_id, timestamp) "
                       ...
                       "UNION "
                       "SELECT open_timestamp AS ref_id FROM deals AS d WHERE d.account_id=:account_id "
                       "UNION "
                       "SELECT close_timestamp AS ref_id FROM deals AS d WHERE d.account_id=:account_id "
                       "UNION "
