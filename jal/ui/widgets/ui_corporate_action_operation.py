...
class Ui_CorporateActionOperation(object):
    def setupUi(self, CorporateActionOperation):
        ...
        QWidget.setTabOrder(self.add_button, self.del_button)
        QWidget.setTabOrder(self.del_button, self.results_table)
    ...
    def retranslateUi(self, CorporateActionOperation):
        ...
        self.account_label.setText(QCoreApplication.translate("CorporateActionOperation", u"A&ccount", None))
        ...
        self.date_label.setText(QCoreApplication.translate("CorporateActionOperation", u"Dat&e/Time", None))
        ...
        self.type_label.setText(QCoreApplication.translate("CorporateActionOperation", u"T&ype", None))
#if QT_CONFIG(tooltip)
