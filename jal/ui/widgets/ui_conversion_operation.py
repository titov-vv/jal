...
class Ui_ConversionOperation(object):
    def setupUi(self, ConversionOperation):
        ...
        self.fee_label = QLabel(ConversionOperation)
        ...
        QWidget.setTabOrder(self.in_symbol_widget, self.fee_widget)
    ...
    def retranslateUi(self, ConversionOperation):
        ...
        self.date_label.setText(QCoreApplication.translate("ConversionOperation", u"D&ate/Time", None))
        self.timestamp.setDisplayFormat(QCoreApplication.translate("ConversionOperation", u"dd/MM/yyyy hh:mm:ss", None))
        self.account_label.setText(QCoreApplication.translate("ConversionOperation", u"A&ccount", None))
        self.tx_hash_label.setText(QCoreApplication.translate("ConversionOperation", u"T&x hash", None))
        self.converted_label.setText(QCoreApplication.translate("ConversionOperation", u"C&onverted", None))
        self.received_label.setText(QCoreApplication.translate("ConversionOperation", u"R&eceived", None))
        ...
        self.fee_label.setText(QCoreApplication.translate("ConversionOperation", u"&Fee", None))
