...
class Ui_SymbolDialog(object):
    def setupUi(self, SymbolDialog):
        ...
        self.CountryLbl.setBuddy(self.CountryCombo)
        ...
        QWidget.setTabOrder(self.TypeCombo, self.CountryCombo)
        QWidget.setTabOrder(self.CountryCombo, self.AddDataButton)
    ...
    def retranslateUi(self, SymbolDialog):
        ...
        self.DataLbl.setText(QCoreApplication.translate("SymbolDialog", u"A&sset attributes", None))
