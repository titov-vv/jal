...
class Ui_TaxWidget(object):
    def setupUi(self, TaxWidget):
        ...
        self.gridLayout.addWidget(self.SaveButton, 8, 2, 1, 1)
        ...
        self.line = QFrame(self.RussianSpecificFrame)
        ...
        self.WarningLbl = QLabel(self.RussianSpecificFrame)
        self.WarningLbl.setObjectName(u"WarningLbl")
        font = QFont()
        font.setItalic(True)
        self.WarningLbl.setFont(font)

        self.verticalLayout.addWidget(self.WarningLbl)
        ...
        self.NoSettlement = QCheckBox(self.RussianSpecificFrame)
        self.NoSettlement.setObjectName(u"NoSettlement")

        self.verticalLayout.addWidget(self.NoSettlement)


        self.gridLayout.addWidget(self.RussianSpecificFrame, 4, 0, 1, 3)
