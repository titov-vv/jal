...
class Ui_DepositsReportWidget(object):
    def setupUi(self, DepositsReportWidget):
        ...
        self.DepositsDate.setTimeSpec(Qt.TimeSpec.UTC)
        ...
        self.DetailsTableView.setFrameShape(QFrame.Shape.Panel)
        self.DetailsTableView.setFrameShadow(QFrame.Shadow.Sunken)
