...
class TransferWidget(AbstractOperationDetails):
    ...
    def __init__(self, parent=None):
        ...
        self.ui.from_account_widget.setup_selector(self._from_account_model, AccountListDialog, self)
        self._to_account_model = AccountListModel(self)
        self.ui.to_account_widget.setup_selector(self._to_account_model, AccountListDialog, self)
        self._fee_account_model = AccountListModel(self)
        self.ui.fee_account_widget.setup_selector(self._fee_account_model, AccountListDialog, self)
        ...
        self.ui.gas_symbol_widget.setup_selector(self._gas_symbols_model, SymbolListDialog, self)
