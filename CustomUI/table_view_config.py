...
class TableViewConfig:
    ...
    def __init__(self, parent):
        ...
        self.actions = [
            ...
            (parent.AddActionDetail,        "clicked()",                partial(parent.operations.addOperationChild, TRANSACTION_ACTION)),
            (parent.RemoveActionDetail,     "clicked()",                partial(parent.operations.deleteOperationChild, TRANSACTION_ACTION)),
