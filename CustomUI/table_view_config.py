...
class TableViewConfig:
    ...
    def __init__(self, parent):
        ...
        self.widget_mappers = {
            ...
            self.ACTIONS: [("timestamp", parent.ActionTimestampEdit, parent.widthForTimestampEdit),
                           ("account_id", parent.ActionAccountWidget, 0),
                           ("peer_id", parent.ActionPeerWidget, 0)],
            self.ACTION_DETAILS: None,
            self.TRADES: [("timestamp", parent.TradeTimestampEdit, parent.widthForTimestampEdit),
                          ("corp_action_id", parent.TradeActionWidget, 0),
                          ("account_id", parent.TradeAccountWidget, 0),
                          ("asset_id", parent.TradeAssetWidget, 0),
                          ("settlement", parent.TradeSettlementEdit, 0),
                          ("number", parent.TradeNumberEdit, parent.widthForTimestampEdit),
                          ("price", parent.TradePriceEdit, 0) ,
                          ("qty", parent.TradeQtyEdit, 0) ,
                          ("coupon", parent.TradeCouponEdit, 0) ,
                          ("fee", parent.TradeFeeEdit, 0) ],
            self.DIVIDENDS: [("timestamp", parent.DividendTimestampEdit, parent.widthForTimestampEdit),
                             ("account_id", parent.DividendAccountWidget, 0),
                             ("asset_id", parent.DividendAssetWidget, 0),
                             ("number", parent.DividendNumberEdit, parent.widthForTimestampEdit),
                             ("sum", parent.DividendSumEdit, 0),
                             ("note", parent.DividendSumDescription, 0),
                             ("sum_tax", parent.DividendTaxEdit, 0),
                             ("note_tax", parent.DividendTaxDescription, 0)],
            self.TRANSFERS: [("from_acc_id", parent.TransferFromAccountWidget, 0),
                             ("to_acc_id", parent.TransferToAccountWidget, 0),
                             ("fee_acc_id", parent.TransferFeeAccountWidget, 0),
                             ("from_timestamp", parent.TransferFromTimestamp, parent.widthForTimestampEdit),
                             ("to_timestamp", parent.TransferToTimestamp, parent.widthForTimestampEdit),
                             ("fee_timestamp", parent.TransferFeeTimestamp, parent.widthForTimestampEdit),
                             ("from_amount", parent.TransferFromAmount, 0),
                             ("to_amount", parent.TransferToAmount, 0),
                             (
                             "fee_amount", parent.TransferFeeAmount, 0),
                             ("note", parent.TransferNote, 0)]
        }
        self.dialogs = {
