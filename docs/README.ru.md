...
[**Руководство пользователя**](https://titov-vv.github.io/jal/manual/README) подробно описывает всю программу - счета и операции, инвестиции, криптовалюты, загрузку отчетов брокеров, отчеты, налоги, резервные копии и разбор проблем. Оно также открывается из меню *Помощь->Руководство пользователя*.
