...
- налоговый отчет для подготовки декларации 3-НДФЛ по резульатам операций с зарубежными ЦБ
...
* [requests](https://requests.readthedocs.io/) - обновление котировок через интернет
...
### Screenshots
*см. анлийскую версию данной страницы, русскоязычные скриншоты будут добавлены позднее*
