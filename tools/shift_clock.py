...
operations left with the arrival before the departure (on every run).
...
def main() -> None:
    ...
    parser.add_argument("--csv", metavar="PREFIX", default="reclock",
                        help="where the findings are written: PREFIX_day_markers.csv, "
                             "PREFIX_reordered_legs.csv")
